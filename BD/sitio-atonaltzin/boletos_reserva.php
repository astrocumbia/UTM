...
<!-- TERMINA BARRA SUPERIOR -->
	...
	<div class="container">
		...
		<div class="row">
			<form id="formulario_reserva_boleto" action="">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<select id="select_hora_salida" class="form-control">
							    ...
							    <option value="two">8:30 am</option>
							    <option value="three">9:00 am</option>
							    <option value="four">9:30 am</option>
							</select>
						</div>
					</div>	
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="col-lg-offset-2">
								<button type="reset" class="btn btn-danger ">Cancelar Reserva</button>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div clas="col-lg-offset-2">
								<button type="submit" class="btn btn-info">Aceptar Reservar </button>
							</div>
						</div>
					</div>					
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="col-lg-offset-8">
								<h3><span class="label label-primary">Reservado</span></h3>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div clas="col-lg-offset-2">
								<h3><span class="label label-success">Vendido</span></h3>
							</div>
						</div>
