...
<!-- TERMINA BARRA SUPERIOR -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <select id="select_tipo_busqueda" class="form-control">
                        <option value="one">Nombre de cliente</option>
                        <option value="two">Fecha y hora</option>
                        <option value="three">Fecha</option>
                        <option value="four">Suburban</option>
                </select>           
            </div>
            <!--Select tipo de busqueda-->
            <div class="col-md-2">
                <select id="select_busqueda_por" class="form-control">
                        <option value="one">Todos los boletos</option>
                        <option value="one2">Boletos Vendidos </option>
                        <option value="two">Boletos Reservados</option>
                </select>       
            </div>
        ...
        <div class="table-responsive col-md-12">
            ...
            <thead>  
              <tr>  
                <th bgcolor="#45A0FF"> Número </th>  
                <th bgcolor="#45A0FF"> Nombre </th>  
                <th bgcolor="#45A0FF"> Origen/Destino </th>  
                <th bgcolor="#45A0FF"> Fecha </th>  
                <th bgcolor="#45A0FF"> Asiento </th>
                <th bgcolor="#45A0FF"> Precio </th>
                <th bgcolor="#45A0FF"> Estado </th>
                <th > </th>
                <th > </th>
                <th > </th>
                <th > </th>
            ...
            <tbody>
                <tr class="info">
                    ...
                    <td class="info" width="19%">
                        Rosa Aquino Lopez Salar Mendoza
                    </td>
                    <td class="info" width="13%">
                        Nochixtlan-Huajuapan
                    </td>
                    <td class="info" width="13%">
                        14:00 6 Enero 2014
                    </td>
